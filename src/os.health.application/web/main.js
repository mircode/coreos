...
(function() {
	...
	var MODULE = angular.module('os.health',
			[ 'ngRoute', 'ngResource' ]);

	MODULE.config( function($routeProvider) {
		$routeProvider.when('/', { controller: mainProvider, templateUrl: '/os.health/main/htm/home.htm'});
		$routeProvider.when('/about', { templateUrl: '/os.health/main/htm/about.htm'});
